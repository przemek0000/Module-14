        ...
        <StyledDiv>
            ...
            <Section
                ...
                body={<div>Od zawsze interesowałem się komputerami 💻, swój pierwszy komputer dostałem w wieku 8 lat. Obecnie ucze się Frontend Development z YouCode
                    ...
                    grać na pianinie 🎹, a jeśli chodzi o słuchanie to zależy od sytuacji w jakiej się znajduje lub nastroju - rock, dark techno, ambient, trance, muzyka filmowa, soundtracks.
                </div>}
            />
        </ StyledDiv>
    )
